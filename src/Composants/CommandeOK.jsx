  ...
  return (
    <div className="Ent">
      {/* <button className="btn-plus1">
        <NavLink className='tr' to="/DemandeDeCotation">Appel d'offres</NavLink>
      </button> */}
      <div className="Cont-tableau14">
        <div className="cont-plan5">
          <div className="cont-p5">
            <h4 className="Plan-name">Commandes</h4>
          </div>
        </div>
        <div>
